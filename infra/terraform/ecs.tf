  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "TRANSCRIBE_LANGUAGE_CODE", value = var.voice_transcribe_language_code },
        { name = "VOICE_AUDIO_URL_TTL_SECONDS", value = tostring(var.voice_audio_url_ttl_seconds) },
        { name = "VOICE_MAX_TEXT_LENGTH", value = tostring(var.voice_max_text_length) },
